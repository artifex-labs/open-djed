...
export const Header = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <header
        className="sticky top-0 left-0 right-0 py-4 px-8 bg-light-navbar dark:bg-dark-navbar shadow-sm dark:shadow-primary/30 z-50 transition-all duration-200 ease-in-out"
      >
