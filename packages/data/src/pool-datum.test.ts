...
const poolDatumCbor = ''
...
test('pool datum from', () => {
  expect(Data.from(
    poolDatumCbor,
    PoolDatum,
  )).toEqual(poolDatumRich)
})

test('pool datum to', () => {
  expect(Data.to(poolDatumRich, PoolDatum),
